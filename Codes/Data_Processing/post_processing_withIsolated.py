...
folds = ["fold1_P16", "fold2_P13", "fold3_P30", "fold4_P38"]
best_dice_score = []
old_dice_score = []
inx=1
...
for fold in folds:
    ...
    for i in range(real_imgs.shape[2]):
        ...
        pa = f"/home/ysun@gaps_domain.ssr.upm.es/Craneal_CT/resultdele/{inx}/P_{i}.png"
        plt.imsave(pa, pred_imgs_clean_holes[:, :, i], cmap='gray', format='png')
        plt.close() 
    inx=inx+1
