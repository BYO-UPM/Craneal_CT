...
# Paths of test set and DL models
path_test = "/media/CT_Craneal/DL_Models/Model_3D/3D_data_cv/cv"
path_model = "/media/CT_Craneal/DL_Models/Model_3D/"
encoders = ['vanilla', 'resnet50', 'vgg16']
...
for encoder in encoders:
    ...
    for i in range(1, 10):
        ...
        # Post-processing: remove isolated meshes
        post_dust = cc3d.dust(
